...
def metadata_filter(filename):          #defining function and using filename as a variable to call the function which is described later
    ...
    for col in date_columns:            #col holds a data from the column of 'Sample Data start H2' at a time then for other , kasari data read hunxa?
...
all_filtered_data = pd.DataFrame()  #New empty dataframe initialization
